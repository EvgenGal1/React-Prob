...
function AccordionReact(props) {
  // !!! https://webformyself.com/kak-sozdat-accordion-react-s-nulya-bez-ispolzovaniya-vneshnej-biblioteki/
  // const App = () => {
  const accordionData = {
    title: "Section 1",
  ...
  return (
    <React.Fragment>
      <h1>React Accordion Demo - AccordionReact</h1>
...
// !!! раб но чёт с ключом - react_devtools_backend.js:4026 Warning: Each child in a list should have a unique "key" prop. Check the render method of `AppAccordion`. See https://reactjs.org/link/warning-keys for more information.
const AppAccordion = () => {
  const accordionData = [
    {
      title: "Section 1",
  ...
  return (
    <div>
      <h1>React Accordion Demo - AppAccordion</h1>
      <div className="accordion">
