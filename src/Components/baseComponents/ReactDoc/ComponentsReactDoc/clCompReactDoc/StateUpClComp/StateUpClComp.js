    ...
    return (
      <div className="StateUpClComp---">
        ...
        <div className="StateUpClComp__content---">
          <div>
            <div className="CalculatorClComp__descript">
              <h3>Cоздадим калькулятор температуры</h3>
              <p>
                Мы начнем с компонента под названием <code>BoilingVerdict</code>
                . Он принимает <code>celsius</code> температуру в качестве опоры
                и выводит, достаточно ли ее для кипячения воды:
              </p>
            </div>
            ...
            <div className="CalculatorClComp__descript">
              <p>
                ...
                отображает, <code>&lt;input&ut;</code>который позволяет вам
                ввести температуру и сохраняет ее значение в формате{" "}
                <code>this.state.temperature</code>.
              </p>
              <p>
                Кроме того, он отображает <code>BoilingVerdictдля</code>{" "}
                текущего входного значения.
              </p>
            </div>
            <div className="CalculatorClComp__content">
              <pre>
